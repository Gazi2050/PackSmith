...
describe('timeAgo', () => {
    ...
    it('should handle a large number of seconds correctly', () => {
        const now = new Date();
        const result = timeAgo(new Date(now.getTime() - 100 * 60 * 60 * 1000));
